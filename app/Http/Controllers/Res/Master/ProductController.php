            ...
            wbcm_paginated_collection(
                ...
                wbcm_model('master.product')::where(
                    $this->buildWhere()
                        ...
                        ->index('image_id')->mode('id')
                        ->index('unit_id')->mode('id')
                        ->index('second_unit_id')->mode('id')
                        ->index('third_unit_id')->mode('id')
                        ->index('fourth_unit_id')->mode('id')
                        ->index('fifth_unit_id')->mode('id')
                        ->index('active')->mode('boolean')
                        ->index('locked')->mode('boolean')
                        ->index('monitor_stock')->mode('boolean')
                        ->index('purchase')->mode('boolean')
                        ->index('sales')->mode('boolean')
                        ->done()
                )
