...
namespace App\Http\Requests\Api\Hrm\Employee;
...
class AmendRequest extends AuthIdRequest
{
    ...
    public function additionalRules()
    {
        return [
            ...
            'blood_type_id' => [
                'nullable',
                'wb_exists:\App\Models\Hrm\BloodType',
            ],
            'gender_id' => [
                'nullable',
                'wb_exists:\App\Models\Hrm\Gender',
            ],
            'first_branch_id' => [
                'nullable',
            ...
            'first_job_title_id' => [
                'nullable',
                'wb_exists:\App\Models\Hrm\JobTitle',
            ],
            'start_date' => [
                'nullable',
                'date',
            ...
            'employee_addresses.*.address_type_id' => [
                'nullable',
                'wb_exists:\App\Models\Hrm\AddressType',
            ],
            ...
            'employee_contacts.*.contact_type_id' => [
                'nullable',
                'wb_exists:\App\Models\Hrm\ContactType',
            ],
            ...
            'employee_photos.*.employee_photo_type_id' => [
                'nullable',
                'wb_exists:\App\Models\Hrm\EmployeePhotoType',
            ],
            'employee_photos.*.image_id' => [
                'nullable',
                'wb_exists:\App\Models\Storage\Image',
            ],
        ];
    }
}
