...
export default {
            ...
            meta: {
                'account_type': {
                    sortOrders: [
                        ...
                        { index: 'profit_loss_account_group_id', title: 'Grup Akun Neraca' },
                    ],
                    counts: [10, 25, 50, 100],
                    show: true,
                },
    ...
    created() {
        this.fetchAndSetFormData(
            '/ajax/accounting/trial_balance_account_group/' + this.$route.params.id,
    ...
    methods: {
        ...
        fetchResult(index) {
            return axios.get('/ajax/accounting/' + index, {
                params: {
                    'trial_balance_account_group_id': this.$route.params.id,
                    ...this.query[index],
                }
            })
        },
