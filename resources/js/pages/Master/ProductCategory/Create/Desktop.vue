    ...
    <fragment>
        ...
        <bsb-card class="my-3">
            <bsb-card-body-spinner-error-back
                ...
                :default-back="{ name: 'master.productCategory' }"
            >
                <h5 class="mb-3">Tambah Kategori Barang</h5>
                <form
                    class="mt-5"
                    @submit.prevent="
                        submitForm('/ajax/master/product_category', 'post', {
                            resolve: true,
                            reject: false
                        }).then(() => $router.push({ name: 'master.productCategory' }))
                    "
                >
                    <bsb-form-group>
                        <label>Kode</label>
