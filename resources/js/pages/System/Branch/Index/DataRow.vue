    ...
    <bsb-screen>
        <template v-slot:desktop>
            <tr>
                ...
                <bsb-td justify="center" v-if="flWithBranchType">
                    {{ item['branch_type']['code'] }} - {{ item['branch_type']['name'] }}
                </bsb-td>
            ...
            <bsb-list-group-item>
                <bsb-list-group-item-content>
                    <template v-slot:content>
                        ...
                        <small v-if="flWithBranchType"><b>{{ item['branch_type']['code'] }} - {{ item['branch_type']['name'] }}</b></small>
                    </template>
