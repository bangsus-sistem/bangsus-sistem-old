<template>
    <WidgetWrapper module-ref="authentication_log" widget-type-ref="traffic" class="col-12 col-lg-6 col-xl-4">
        <bsb-card>
            <bsb-card-body>
                <h5 class="card-title">Traffic Login Pengguna</h5>
