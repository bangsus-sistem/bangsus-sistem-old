...
class ModuleSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = $this->parseData([
            'auth' => [
                ...
                ['id' => '0005', 'ref' => 'role', 'name' => 'Role'],
                ['id' => '0006', 'ref' => 'user', 'name' => 'User'],
                ['id' => '0007', 'ref' => 'authentication_token', 'name' => 'Token Autentikasi'],
                ['id' => '0008', 'ref' => 'api_token', 'name' => 'Token API'],
            ],
            'logs' => [
    ...
    {
        $return = [];
        foreach ($data as $packageRef => $module) {
            $package = \DB::table('package')->where('ref', $packageRef)->first();
            $return[] = [
